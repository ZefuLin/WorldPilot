...
class DiT(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Timestep encoder
        # self.config.compute_dtype may be missing in some code paths, so handle it early.
        compute_dtype = getattr(self.config, 'compute_dtype', torch.float32)
        self.timestep_encoder = TimestepEncoder( # TODO: during training self.config.compute_dtype is available, but in eval it may be missing.
