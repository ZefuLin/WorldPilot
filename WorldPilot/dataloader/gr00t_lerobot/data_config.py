...
from WorldPilot.dataloader.gr00t_lerobot.datasets import ModalityConfig
from WorldPilot.dataloader.gr00t_lerobot.transform.base import ComposedModalityTransform, ModalityTransform
from WorldPilot.dataloader.gr00t_lerobot.transform.concat import (
    ConcatTransform,
    ConcatStateActionTransform,
    ConcatDeltaChunkTransform,
)
from WorldPilot.dataloader.gr00t_lerobot.transform.padding import (
    BimanualPadTransform,
    BimanualPadAndGripperPadTransform,
)
from WorldPilot.dataloader.gr00t_lerobot.transform.state_action import (
...
from WorldPilot.dataloader.gr00t_lerobot.transform.video import (
    VideoColorJitter,
    VideoCrop,
    VideoResize,
    VideoToNumpy,
...
class DualPiper16DataConfig(AgilexDataConfig):
...
ROBOT_TYPE_CONFIG_MAP = {
    ...
    # Huairou DualPiper
    "dual_piper_16": DualPiper16DataConfig(),
